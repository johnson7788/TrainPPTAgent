...
#模拟图片的幻灯片的响应格式
# 封面
cover_data = {"type": "cover", "data": {"title": "2025科技前沿动态", "text": "探索人工智能、量子计算、生物技术等领域的最新突破与未来发展方向"}}
# 目录
contents_data = {"type": "contents", "data": {"items": ["人工智能新突破", "量子计算商业化进程", "生物技术与医疗革新", "新能源与可持续发展", "通信技术与连接未来", "先进制造与机器人技术"]}}
# 过渡页
transition_data = {"type": "transition",
 "data": {"title": "人工智能新突破", "text": "人工智能技术实现多模态融合、参数效率优化与个性化服务，推动各行业创新应用"}}
# 内容页
content_data1 = {"type": "content", "data": {"title": "大语言模型的进化", "items": [
...
content_data2 =  {"type": "content", "data": {"title": "生成式AI的商业应用", "items": [
...
content_data3 =  {"type": "content", "data": {"title": "AI与脑科学的交叉研究", "items": [
...
async def aippt_content(request: AipptContentRequest):
    print(f"请求生成ppt内容:{request.content}")
